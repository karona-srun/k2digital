...
class TikTokController extends Controller
{
	...
	public function index(Request $request)
	{
		...
		curl_setopt_array($curl, [
			...
			CURLOPT_HTTPHEADER => [
				"x-rapidapi-host: https://tik-tok-feed.p.rapidapi.com",
				"x-rapidapi-key: 29021beedcmshf4473c2b9391bfcp1426e3jsnfaf0473e82b4"
			],
		]);
	...
	public function getVideoWithOutWatermark(Request $request)
    {
        $binary = file_get_contents($request->url);
